...
#
#
#A band is a conglomerate of contacts, each with their own associated role (which might or might not be
...
class Band:
	...
	def addRole(self, roleName, contact):
		...
		#Eventually, because of the chance of multiple same-titled roles occuring within the band, the user
		#should be told that a band role exists if already put in, and should be allowed the chance to confirm
